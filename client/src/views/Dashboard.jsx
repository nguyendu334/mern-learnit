...
import OverlayTrigge from 'react-bootstrap/OverlayTrigger';
    ...
    if (postLoading) {
        body = (
            <div className="spinner-container">
                <Spinner animatin="border" variant="info" />
            </div>
        );
        ...
        body = (
            <>
                <Row className="row-cols-1 row-cols-md-3 g-4 mx-auto my-3">
                    {posts.map((post) => (
                ...
                <OverlayTrigge placement="left" overlay={<Tooltip>Add a new thing to learn</Tooltip>}>
    ...
    return (
        <>
            ...
            <Toast
                ...
                className={`bg-${type} text-white pt-2 text-center`}
